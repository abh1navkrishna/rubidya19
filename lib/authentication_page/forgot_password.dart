    ...
    try {
      ...
      if (response['msg'] == 'User Add Successfully') {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
                'User added successfully! UserID: $userId'), // Add $userId here
          ...
          children: [
            ...
            Padding(
              ...
              child: Align(
                  alignment: Alignment.topLeft,
                  child: Text(
                    "To reset your password, enter your Email-ID and verify",
              ...
              child: TextField(
                decoration: InputDecoration(
                  ...
                  prefixIcon: Icon(
                    Icons.email,
                    size:
                        15, // You can replace 'Icons.email' with the icon you want
                    color: bordercolor,
                  ),
                ),
                onChanged: (text) {
